...
from torchvision.transforms import ToPILImage, Compose, RandomCrop, ToTensor, transforms
import torch
...
class HW4TrainDataset(Dataset):
    ...
    def __getitem__(self, idx):
        degraded_name = self.image_files[idx]
        
        # 將退化圖片檔名對應到乾淨圖片檔名 (例如: rain-1.png -> rain_clean-1.png)
